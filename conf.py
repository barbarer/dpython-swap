...
html_title = 'dpython-swap'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='dpython-swap'
...
course_description = "Duke version of a study for the ITiCSE working group led by Dr. Barbara Ericson, Dr. Janice Pearce, and Dr. Susan Rodger. "
